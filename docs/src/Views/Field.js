...
export let commonPropertiesWithSingle = [
  ...
  [`onBeforeAddRow`,`function`,`undefined`,`Special hook called before a new Row is added to a DataSheet field, after a user interaction. Receives a callback function as a first parameter that is to be called to perform the normal addRow operation, the concerned field object as a second parameter. Applicable only to DataSheet field type.`],
  [`onBeforeRemoveRow`,`function`,`undefined`,`Special hook called before a DataSheet field row is removed, after a user interaction. Receives a callback function as a first parameter that is to be called to perform the normal removeRow operation, the concerned field object as a second parameter and the row index (relative to the field value array) to be removed as a third parameter. Applicable only to DataSheet field type.`],
  [`onBeforeMoveUpRow`,`function`,`undefined`,`Special hook called before a DataSheet field row is moved up, after a user interaction. Receives a callback function as a first parameter that is to be called to perform the normal moveRow operation, the concerned field object as a second parameter and the row index (relative to the field value array) to be moved as a third parameter. Applicable only to DataSheet field type.`],
  [`onBeforeMoveDownRow`,`function`,`undefined`,`Special hook called before a DataSheet field row is moved down, after a user interaction. Receives a callback function as a first parameter that is to be called to perform the normal moveRow operation, the concerned field object as a second parameter and the row index (relative to the field value array) to be moved as a third parameter. Applicable only to DataSheet field type.`],
  [`onBeforeDuplicateRow`,`function`,`undefined`,`Special hook called before a DataSheet field row is duplicated, after a user interaction. Receives a callback function as a first parameter that is to be called to perform the normal duplicateRow operation, the concerned field object as a second parameter and the row index (relative to the field value array) to be moved as a third parameter. Applicable only to DataSheet field type.`],
