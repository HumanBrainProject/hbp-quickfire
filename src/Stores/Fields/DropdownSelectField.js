 ...
 * @param {boolean} listPosition "bottom" - Can be "top" or "bottom", whether to display the dropdown list above or below the field
...
export default class DropdownSelectField extends DefaultField{
  ...
  static get properties(){
    return union(super.properties,["value", "defaultValue", "options", "optionsUrl", "cacheOptionsUrl", "allowCustomValues",
      "mappingValue", "mappingLabel", "mappingReturn", "returnSingle", "max", "listPosition"]);
  }
